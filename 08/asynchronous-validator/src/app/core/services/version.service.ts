...
export class VersionService {
  ...
  versionValidators(appNameControl: AbstractControl): AsyncValidatorFn {
    return (control: AbstractControl):
      ...
      return this.getVersionLog().pipe(map(vLog => {
        ...
        return compareVersion(newVersion, previousVersion)
          === 1 ? null : {
